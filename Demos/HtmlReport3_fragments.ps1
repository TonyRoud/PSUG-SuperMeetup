...
# Capture all HTML and output to file in one go
ConvertTo-Html -Body $HTML -Head $style | out-file ExampleReports\html_fragments_1.htm -force

Invoke-Item ExampleReports\html_fragments_1.htm